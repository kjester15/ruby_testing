...
describe BinaryGame do
  ...
  describe '#display_turn_order' do
    ...
    subject(:game_main) { described_class.new(1, 10) }
    ...
    before do
      ...
      allow(game_main).to receive(:display_guess)
    ...
    it 'increases guess_count by one' do
      guess = game_main.instance_variable_get(:@guess_count)
      result = guess + 1
      expect(result).to eq(1)
      game_main.display_turn_order(binary_search)
    end
